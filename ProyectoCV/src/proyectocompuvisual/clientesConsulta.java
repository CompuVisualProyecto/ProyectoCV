...
public class clientesConsulta extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor)
    {
        ...
        String Sql="SELECT * FROM clientes WHERE CONCAT(CED_CLI,NOM_CLI,APE_CLI) LIKE '%"+valor+"%'";
        ...
        try {
            ...
            Logger.getLogger(clientesConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
// TODO add your handling code here:
//    String cedcli="",nomcli="",apecli="",telcli="",emailcli="";
...
//        else
//        {
//         cedcli =  (String)tbclientes.getValueAt(fila, 0);
//         nomcli =  (String)tbclientes.getValueAt(fila, 1);
//         apecli =  (String)tbclientes.getValueAt(fila, 2);
//         telcli =  (String)tbclientes.getValueAt(fila, 3);
//         emailcli =  (String)tbclientes.getValueAt(fila, 4);
//         Ventas vn = new Ventas();
//         
//         Ventas.txtcedcli.setText(cedcli);
//         Ventas.txtnomape.setDisabledTextColor(Color.blue);
//         Ventas.txtnomape.setText(nomcli+"   "+apecli);
//         Ventas.txttelf.setDisabledTextColor(Color.blue);
//         Ventas.txttelf.setText(telcli);
//         Ventas.txtcedvend.setText("Administrador");
//         Ventas.txtcodv.setText("VEND001");
//         this.dispose();
//         
//        }
//    } catch (Exception e) {
